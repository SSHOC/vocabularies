...
def createSkos():
    ...
    f = open("sshoc-media.ttl", "w")
    f.write("@prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> .\n")
    f.write("@prefix rdfs: <http://www.w3.org/2000/01/rdf-schema#> .\n")
    f.write("@prefix skos: <http://www.w3.org/2004/02/skos/core#> .\n")
    f.write("@prefix dc: <http://purl.org/dc/elements/1.1/> .\n")
    f.write("@prefix sshoc-media: <https://vocabs.dariah.eu/media-type/> .\n\n")

    f.write("sshoc-media:Schema a skos:ConceptScheme;\n")
    f.write("\trdfs:label \"Media Types from IANA\"@en;\n")
    f.write("\tdc:title \"Media Types from IANA\"@en;\n")

    for mime in mimes:
        f.write("\tskos:hasTopConcept sshoc-media:")
        f.write(mime)
        f.write(";\n")
    ...
    for mime in mimes:
        ...
        for row in reader:
            ...
            narrowers += ("sshoc-media:" + slugify(template) + " ")
            narrowerList.append("sshoc-media:" + slugify(template))
            f.write("sshoc-media:")
            ...
            if template != dict(row).get('Name'):
                ...
                f.write("\"@en;\n")
            f.write("\tskos:broader sshoc-media:")
        ...
        f.write("\tskos:topConceptOf sshoc-media:Schema .\n\n")
